...
@Entity
@Table(name = "succulents_cactus")
public class SucculentsCactus {
	...
	public SucculentsCactus() {
		super();
		// TODO Auto-generated constructor stub
	}

	public SucculentsCactus(Long id, String commonName, String family, String categories, String origin, String climate,
			List<Integer> zone, String imgUrl, Double price, Double sellingPrice, Integer discountPercent,
			Double rating, String description, List<String> benefits, List<String> stepsToGrow,Integer qty) {
		super();
		this.id = id;
	...
	public String toString() {
		return "SucculentsCactus [id=" + id + ", commonName=" + commonName + ", family=" + family + ", categories="
