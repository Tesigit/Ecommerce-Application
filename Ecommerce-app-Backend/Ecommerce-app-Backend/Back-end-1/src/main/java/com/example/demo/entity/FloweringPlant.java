...
public class FloweringPlant {
	...
	public FloweringPlant(Long id, String commonName, String family, String categories,
			String origin, String climate, String zone, String imgUrl, Double price, Double sellingPrice,
			Integer discountPercent, Double rating, String description, List<String> benefits, Integer qty,
	...
	public String toString() {
		return "FloweringPlant [id=" + id + ", commonName=" + commonName
				...
				+ ", benefits=" + benefits + ", stepsToGrow=" + stepsToGrow + ",qty="+qty+"]";
	}
