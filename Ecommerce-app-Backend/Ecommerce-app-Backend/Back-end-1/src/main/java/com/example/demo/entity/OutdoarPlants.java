...
public class OutdoarPlants {
	...
	public OutdoarPlants(Long id,  String commonName, String family, String categories,
			String origin, String climate, String zone, String imgUrl, Double price, Double sellingPrice,
			Double discountPercent, Double rating, String sunlight, String water, String soilType, String growthRate,
			String maxHeight, String description, List<String> benefits, List<String> stepsToGrow,Integer qty) {
		super();
		this.id = id;
	...
	public String toString() {
		return "OutdoarPlants [id=" + id  + ", commonName=" + commonName + ", family="
