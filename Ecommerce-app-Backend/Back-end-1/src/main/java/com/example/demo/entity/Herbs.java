...
public class Herbs {
	...
	public Herbs(Long id, String commonName, String family, String categories, String origin,
	...
	public String toString() {
		return "Herbs [id=" + id  + ", commonName=" + commonName + ", family=" + family
				...
				+ ", stepsToGrow=" + stepsToGrow + ",qty="+qty+"]";
	}
